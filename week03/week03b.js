...
// ADDRESSES
let meetingsData = [];
let addresses = ['7 East 10th Street, 2nd Floor, 10003','155 East 22nd Street,NY 10010','61 Fourth Avenue, 3rd Floor, 9th & 10th St 10003,'];
// console.log(addresses)
...
async.eachSeries(addresses, function(value, callback) {
    ...
    fs.writeFileSync('data/aa-json/addressTest.json', JSON.stringify(meetingsData));
    console.log('*** *** *** *** ***');
